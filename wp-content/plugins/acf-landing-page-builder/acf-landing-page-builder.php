...
final class ACF_Builder
{
    ...
    public function theme_options()
    {
        ...
        $field_builder_default_headings_color = self::get_sub_field('field_builder_default_headings_color');

        $field_builder_default_text_color = self::get_sub_field('field_builder_default_text_color');

        $field_builder_default_button_color = self::get_sub_field('field_builder_default_button_color');

        $field_builder_default_button_bg_color = self::get_sub_field('field_builder_default_button_bg_color');

        $field_content_font = self::get_sub_field('field_content_font');

        $field_text_font_size = self::get_sub_field('field_text_font_size');

        $field_text_font_size_lg = self::get_sub_field('field_text_font_size_lg');

        $field_text_font_size_sm = self::get_sub_field('field_text_font_size_sm');

        $field_text_font_weight = self::get_sub_field('field_text_font_weight');

        $field_text_font_line_height = self::get_sub_field('field_text_font_line_height');

        $field_heading_font = self::get_sub_field('field_heading_font');

        $field_heading_font_weight = self::get_sub_field('field_heading_font_weight');

        $field_heading_font_line_height = self::get_sub_field('field_heading_font_line_height');

        $field_h1_size = self::get_sub_field('field_h1_size');

        $field_h1_size_lg = self::get_sub_field('field_h1_size_lg');

        $field_h1_size_sm = self::get_sub_field('field_h1_size_sm');

        $field_h2_size = self::get_sub_field('field_h2_size');

        $field_h2_size_lg = self::get_sub_field('field_h2_size_lg');

        $field_h2_size_sm = self::get_sub_field('field_h2_size_sm');

        $field_h3_size = self::get_sub_field('field_h3_size');

        $field_h3_size_lg = self::get_sub_field('field_h3_size_lg');

        $field_h3_size_sm = self::get_sub_field('field_h3_size_sm');

        $field_h4_size = self::get_sub_field('field_h4_size');

        $field_h4_size_lg = self::get_sub_field('field_h4_size_lg');

        $field_h4_size_sm = self::get_sub_field('field_h4_size_sm');

        $field_h5_size = self::get_sub_field('field_h5_size');

        $field_h5_size_lg = self::get_sub_field('field_h5_size_lg');

        $field_h5_size_sm = self::get_sub_field('field_h5_size_sm');

        $field_h6_size = self::get_sub_field('field_h6_size');

        $field_h6_size_lg = self::get_sub_field('field_h6_size_lg');

        $field_h6_size_sm = self::get_sub_field('field_h6_size_sm');

        $variables = "
		:root {
			--field_builder_default_headings_color: {$field_builder_default_headings_color};
			--field_builder_default_text_color: {$field_builder_default_text_color};
			--field_builder_default_button_color: {$field_builder_default_button_color};
			--field_builder_default_button_bg_color: {$field_builder_default_button_bg_color};
			--field_content_font: {$field_content_font};
			--field_text_font_size: {$field_text_font_size};
			--field_text_font_size_lg: {$field_text_font_size_lg};
			--field_text_font_size_sm: {$field_text_font_size_sm};
			--field_text_font_weight: {$field_text_font_weight};
			--field_text_font_line_height: {$field_text_font_line_height};
			--field_heading_font: {$field_heading_font};
			--field_heading_font_weight: {$field_heading_font_weight};
			--field_heading_font_line_height: {$field_heading_font_line_height};
			--field_h1_size: {$field_h1_size};
			--field_h1_size_lg: {$field_h1_size_lg};
			--field_h1_size_sm: {$field_h1_size_sm};
			--field_h2_size: {$field_h2_size};
			--field_h2_size_lg: {$field_h2_size_lg};
			--field_h2_size_sm: {$field_h2_size_sm};
			--field_h3_size: {$field_h3_size};
			--field_h3_size_lg: {$field_h3_size_lg};
			--field_h3_size_sm: {$field_h3_size_sm};
			--field_h4_size: {$field_h4_size};
			--field_h4_size_lg: {$field_h4_size_lg};
			--field_h4_size_sm: {$field_h4_size_sm};
			--field_h5_size: {$field_h5_size};
			--field_h5_size_lg: {$field_h5_size_lg};
			--field_h5_size_sm: {$field_h5_size_sm};
			--field_h6_size: {$field_h6_size};
			--field_h6_size_lg: {$field_h6_size_lg};
			--field_h6_size_sm: {$field_h6_size_sm};
		}";
